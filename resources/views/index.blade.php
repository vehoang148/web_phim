...
<head>
    ...
    <script src='{{ asset('js/jquery.min.js') }}' id='halim-jquery-js'></script>
...
<body class="home blog halimthemes halimmovies" data-masonry="">
                ...
                <div class="col-md-5 col-sm-6 halim-search-form hidden-xs">
                    <div class="header-nav">
                        <div class="col-xs-12">
                            ...
                            <div class="form-group from-timkiem">
                                    ...
                                    <div class="row ">
                                        <div class="input-group col-xs-12">
                                            ...
                                            <div class="input-group-append">
                                                <button class="btn btn-primary col-md-3" type="submit">Tìm
                                                    kiếm</button>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <ul id="menu-menu_1" class="nav navbar-nav navbar-left">
                            ...
                            @foreach ($category as $key => $cate_home)
                                <li class="mega"><a title="Phim Mới"
                                        href="{{ route('category', $cate_home->slug) }}">{{ $cate_home->title }}</a>
                                </li>
                            @endforeach
    ...
    //Khi ấn button thì sẽ đến id trailer
    <script>
